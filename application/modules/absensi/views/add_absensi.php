				...
				<div class="card">
					<div class="card-body">
						...
						   <form class="forms-sample" method="POST" action="javascript:tambah()" id="form" enctype="multipart/form-data">
							<input type="hidden" value="" name="id_absensi" id="id_absensi"/> 
                    ...
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" class="form-control" id="tgl" name="tgl" placeholder="Tanggal"><small class="help-block text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Jam Masuk</label>
                        <input type="time" class="form-control" id="jam_masuk" name="jam_masuk" placeholder="Jam Masuk"><small class="help-block text-danger"></small>
                    </div>
                </form> 
...
function save()
{
    ...
    if(save_method == 'add') {
    	var url = "<?php echo site_url('absensi/ajax_add')?>";
    } else {
    	var url = "<?php echo site_url('absensi/ajax_update')?>";
    }
