				...
				<div class="card">
					<div class="card-body">
						...
						   <form class="forms-sample" method="POST" action="javascript:tambah()" id="form" enctype="multipart/form-data">
							<input type="hidden" value="" name="id_format" id="id_format"/> 
							<div class="form-group">
                                <label>Kata Pembuka</label> 
                                <textarea class="form-control" id="pembuka" name="pembuka" placeholder="Sehubungan dengan kegiatan ..." rows="4"></textarea>
                                <small class="help-block text-danger" id="pesan"></small>
                            </div>
                            <div class="form-group">
                                <label>Kata Penutup</label> 
                                <textarea class="form-control" id="penutup" name="penutup" placeholder="Harap membawa QR Code ini ..." rows="4"></textarea>
...
<script type="text/javascript">
    function tambah()
    {
        ...
        $('.title').text('Tambah Data format'); // Set Title to Bootstrap modal title
    }
    ...
    if(save_method == 'add') {
    	var url = "<?php echo site_url('format/ajax_add')?>";
    } else {
    	var url = "<?php echo site_url('format/ajax_update')?>";
    }
